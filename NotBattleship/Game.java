...
//         for(Boat b: teamOne) {
//            System.out.println(String.format("%s%d is located at %s.", b.getID(),b.getTeam(),b.getLocation()));
//         }
//         for(Boat b: teamTwo) {
//             System.out.println(String.format("%s%d is located at %s.", b.getID(),b.getTeam(),b.getLocation())); 
//         }
...
// 					choices[0] = s.nextInt();
// 					if (b[n] instanceof Cruiser || b[n] instanceof Destroyer || b[n] instanceof AircraftCarrier) {
// 						choices[1] = s.nextInt();
// 					}
