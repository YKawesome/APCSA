public class Recursion1 {
  ...
  if(str.length()==0) return "";
    ...
    if(str.substring(str.length()-1).equals("x")) return changeXY(str.substring(0,str.length()-1))+"y";
  ...
  if(str.length()<=1) return str;
    ...
    if(str.substring(str.length()-2).equals("pi")) return changePi(str.substring(0, str.length()-2))+"3.14";
  ...
  if(str.length()==0) return str;
    ...
    if(str.substring(str.length()-1).equals("x")) return noX(str.substring(0,str.length()-1));
  ...
  if(str.length()<=1) return str;
  else return allStar(str.substring(0,str.length()-1)) + "*" + str.substring(str.length()-1);
}
  ...
  if(str.length()<=1) return str;
    ...
    else return pairStar(str.substring(0,1)) + pairStar(str.substring(1,str.length()));
  }
}
  ...
  return str.length()<=2 ? 0 : (str.charAt(0)==str.charAt(2) ? 1 : 0) + countPairs(str.substring(1,str.length()));
}
  ...
  if(str.length()<=1) return 0;
    ...
    if(str.substring(0,2).equals("xx")) return 0 + countHi2(str.substring(1));
    else if(str.charAt(0)=='x') return 0 + countHi2(str.substring(2));
  ...
  if(str.length()<=1) return "";
    ...
    if(str.charAt(0)=='(') return str.substring(0, str.indexOf(")")+1) + parenBit(str.substring(str.indexOf(")")));
